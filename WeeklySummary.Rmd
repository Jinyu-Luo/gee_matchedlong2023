...
* Generate BAV using rnorm(size = 1, prob = pscore, n = 250)
* Set visit to be 5. 
...
* Fit GEE with exchangeable structure to the full data using n = 250 
* Use Propensity score matching to get matched data. 
* Fit Gee with exchangeable structure to the matched data. 
